...
@section('AMLCITReqToApproveContent')
...
<table class="table mt-5">
  ...
  @foreach($data as $item)
    <tr>
      ...
      <a href="{{route('AMLCwork.ITapprove',[$worker,$item->reference])}}"><button type="button" class="btn btn-success">Approve</button></a>
      <a href="{{route('AMLCwork.ITdisapprove',[$worker,$item->reference])}}"><button type="button" class="btn btn-danger">Disapprove</button></a>
      <a href="{{route('AMLCwork.ITfound',[$worker,$item->reference])}}"><button type="button" class="btn btn-warning">Found in stock</button></a>
