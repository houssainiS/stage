...
<div class="container">
  ...
  <div class="hidden-buttons">
    <a href="{{route('DAFITrequest.order',$worker)}}" class="custom-button">IT</a>
    <a href="{{route('DAFSTrequest.order',$worker)}}" class="custom-button">Stationary</a>
  </div>
  <div class="hidden-buttons2">
    <a href="{{route('DAFIThistory',$worker)}}" class="custom-button">IT</a>
    <a href="{{route('DAFSThistory',$worker)}}" class="custom-button">Stationary</a>
    <a href="{{route('DAFHistory',$worker)}}" class="custom-button">ALL</a>
  </div>
</div>
